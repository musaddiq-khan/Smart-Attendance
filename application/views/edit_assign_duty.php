...
//            console.log(JSON.stringify(arr));
            ...
            $.post("<?php echo base_url()?>master/edit_duty_save", {arr: JSON.stringify(arr),exam_id: "<?php echo $this->input->get('id');?>", rs_max_duty:"<?php echo $rs_max_duty;?>",rs_count:"<?php echo $rs_count;?>",rls_max_duty:"<?php echo $rls_max_duty;?>",rls_count:"<?php echo $rls_count;?>",ds_max_duty:"<?php echo $ds_max_duty;?>",ds_count:"<?php echo $ds_count;?>"}, function(result){
                console.log(result);
