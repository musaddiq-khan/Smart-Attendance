...
<body class="padTop53 " >
						...
						<?php echo $this->session->flashdata('message');?>
                            <div class="box">
                                ...
                                <div id="collapseOne" class="accordion-body collapse in body">
                                    <form action="<?php echo base_url().'dutyadmin/edit_changepass';?>" class="form-horizontal" id="formname" method="post" enctype="multipart/form-data">
   ...
   <!-- FOOTER -->
    ...
    function isvaliddatapass(oldpass)
	{
		...
		var strURL="<?php echo base_url();?>dutyadmin/check_password?oldpass="+oldpass;
