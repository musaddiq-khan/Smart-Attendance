						...
						<div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="collapseOne" class="accordion-body collapse in body">
                                    <form action="<?php echo base_url().'master/print_report';?>" class="form-horizontal" id="brand-validate" method="post" target="_blank">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-4">Duty Designation<font style="color: red;">*</font></label>
                                            <div class="col-lg-4">
                                                <select name="d_desig" class="form-control" required="">
                                                    <option value="-1">--All--</option>
                                                    <?php
                                                    if(is_array($d_desig) && count($d_desig)>=1){
                                                        foreach($d_desig as $val){
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-4">Advanced<font style="color: red;">*</font></label>
                                            <div class="col-lg-4" style="margin-top: 6px;">
                                                <input type="radio" onclick="$('.advanced').slideDown();" name="advanced" value="1" style="float: left;"><label style="margin-left: 8px;margin-right: 8px;float: left;">Yes</label>
                                                <input type="radio" onclick="$('.advanced').slideUp();" name="advanced" value="0" checked style="float: left;" required><label style="margin-left: 8px;margin-right: 8px;float: left;">No</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="advanced" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <select name="ex_date" class="form-control" required="" onchange="getTime(this.value);">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-lg-4">Session<font style="color: red;">*</font></label>
                                                <div class="col-lg-4">
                                                    <select name="session" class="form-control" required="" id="time_drop">
                                                        <option value="">--Select--</option>
