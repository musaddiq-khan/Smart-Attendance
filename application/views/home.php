                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-12 ani">
                        ...
                        <div class="box">
                            ...
                            <br>
                            <a class="button button5"  href="<?php echo base_url('dutyadmin/course_box');?>" role="button">COURSE DETAILS</a>
                    ...
                    <form method="post" action="<?php echo base_url()?>/dutyadmin/csv_upload" enctype="multipart/form-data">
