                    ...
                    <div class="col-lg-12 ani">
                        ...
                        <div class="box">
                            ...
                            if(is_array($data) && count($data)>=1)
                            {
                                ...
                                {
                                    if($value->category == "elective")
                                        $link = base_url()."dutyadmin/sheets?select=".$value->course_name;
                                    else
                                        $link = base_url()."dutyadmin/sheets?select=all";
                                    echo "<tr>
                                       <td><b>{$counter}</b></td>  
                                        <td><b>{$value->course_code}</b></td>
                                        <td><b><a  href='{$link}'>{$value->course_name}</a></b></td>
                                        <td><b>{$value->category}</b></td>
                                        </tr>";
                                        $counter++;
                                }
                            }
