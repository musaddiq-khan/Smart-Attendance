						...
						<?php echo $this->session->flashdata('message');?>
                            <div class="box">
                                ...
                                <div id="collapseOne" class="accordion-body collapse in body">
                                    <form action="<?php echo base_url().'dutyadmin/myprofile_edit_save';?>" class="form-horizontal" id="brand-validate" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group" id="imgh" style="display:none;">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    <input type="file" name="imag" id="imag" title="Select image to upload"/>
                                                </div>
                                            </div>
                                        </div>
                                        
                                        <div class="form-actions no-margin-bottom" style="text-align:center;">
                                         <a href="<?php echo base_url();?>" class="btn btn-primary btn-sm"><i class="icon-reply "></i> Back</a>   &nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-success btn-sm "><i class="icon-save"></i> Save Changes</button>
                                        </div>
