...
var LoadingOverlayProgress = function (t) {
    function e() {
        ...
        return s = $("<div>", {
            ...
            css: $.extend(!0, {position: "absolute", left: "0"}, a.bar)
        }).appendTo(t), x = $("<div>", {
            class: "loadingoverlay_progress_update",
            css: $.extend(!0, {position: "absolute", left: "0",margin: "4% !important",background: "white !important",bottom: "inherit !important"}, a.update)
        }).appendTo(t), r = $("<div>", {
    ...
    var s, r, x, a = $.extend(!0, {}, {
        bar:{bottom:"25px",height:"20px",background:"#9bbb59"},
        text:{bottom:"50px",font:"14pt/1.2 sans-serif",color:"#303030"},
        update: {position: "absolute", left: "0",margin: "4% !important",background: "white !important",bottom: "inherit !important"}
    }, t);
